...
public class CSVUtilTest {
    ...
    public void testGetProperty() throws FileNotFoundException, IOException {
        CSVUtil util = new CSVUtil(Paths.get("src/test/resources/shoot.csv"));
        ...
        util = new CSVUtil(Paths.get("src/test/resources/shoot2.csv"));
    ...
    public void testProbablyBroken() throws FileNotFoundException, IOException {
        CSVUtil util = new CSVUtil(Paths.get("src/test/resources/broken_csv_maybe.csv"));
    ...
    public void testProbablyBroken2() throws FileNotFoundException, IOException {
        CSVUtil util = new CSVUtil(Paths.get("src/test/resources/check.csv"));
